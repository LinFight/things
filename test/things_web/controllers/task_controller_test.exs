defmodule ThingsWeb.TaskControllerTest do
  use ThingsWeb.ConnCase

  import Things.TodoFixtures

  @create_attrs %{title: "some title", body: "some body", schedule_date: ~D[2025-04-28], dead_date: ~D[2025-04-28]}
